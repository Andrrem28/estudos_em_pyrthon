...
Se o resultador for maior que 9:
    resultado é 0
contrário disso:
...
# cpf = '7468248907' # Esse CPF gera o primeiro dígito como 10 (0)
...
cpf_entrada = f'{nove_digitos}{digito_1}{digito_2}'

if cpf_usuario == cpf_entrada:
