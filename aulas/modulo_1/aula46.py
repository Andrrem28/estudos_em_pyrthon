...
Faça a contagem de tentatias do seu usuário.
'''
...
while True:
    ...
    if palavra_formada == palavra_secreta:
        os.system('clear') # Este módulo em uso da função system, irá limpar o terminar. 
        print('VOCÊ ACERTOU! PARABÉNS!')
        print(f'A palavra secreta era: {palavra_secreta}')
        print(f'Você levou {qtd_tentativas} para acertar a palavra')
        letras_acertadas = ''
        qtd_tentativas = 0
